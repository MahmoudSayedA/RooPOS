...
{
    public static bool BeValidCountryCode(string phone)
    {
        if (string.IsNullOrEmpty(phone) || !phone.StartsWith("+"))
            return false;

        // Extract country code (digits after + until first non-digit or end)
        var digits = phone.Substring(1);
        var countryCode = digits.Length >= 1 ? digits.Substring(0, Math.Min(3, digits.Length)) : "";

        // Very basic popular country codes check (you can expand this list)
        var validCountryCodes = new HashSet<string>
    {
        "1", "20", "30", "31", "32", "33", "34", "39", "40", "41", "43", "44", "45", "46", "47", "48", "49",
        "51", "52", "53", "54", "55", "60", "61", "62", "63", "64", "65", "66", "81", "82", "84", "86",
        "91", "92", "93", "94", "95", "98", "211", "212", "213", "216", "218", "220", "221", "222", "223",
        ...
        "856", "870", "878", "880", "886", "960", "961", "962", "963", "964", "965", "966", "967", "968",
        "970", "971", "972", "973", "974", "975", "976", "977", "992", "993", "994", "995", "996", "998"
        // Add more as needed – full list ~250 entries
    };
